...
class SettingsManager : public QObject
{
    ...
    Q_PROPERTY(
        bool systemThemeEnabled READ systemThemeEnabled WRITE setSystemThemeEnabled NOTIFY systemThemeEnabledChanged)
    ...
    Q_PROPERTY(bool hardwareAcceleration READ hardwareAcceleration WRITE setHardwareAcceleration NOTIFY
    ...
    Q_PROPERTY(bool smartSuggestionsEnabled READ smartSuggestionsEnabled WRITE setSmartSuggestionsEnabled NOTIFY
                   smartSuggestionsEnabledChanged)
