...
Item {
    ...
    Item {
        ...
        Rectangle {
            ...
            height: 18
            radius: 9
            color: "#E8E0F0"  // Light gray/purple background
        }
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.0; color: "#62DB50" }  // Light green
                GradientStop { position: 1.0; color: "#34752B" }  // Dark green
            }
        }
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 1.0; color: "#D214FD" }  // Purple/Magenta
            }
